...
package net.catenax.traceability.investigation.domain.model.edc.agreement;
...
public class ContractAgreement {
	...
	/**
	 * The id of the policy that describes how the {@link net.catenax.traceability.investigation.domain.model.edc.asset.Asset} of this contract may be used by the consumer.
	 *
	 * @return policy
	 */
