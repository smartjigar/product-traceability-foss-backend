...
import net.catenax.traceability.investigation.domain.model.edc.notification.ContractNegotiationDto;
import net.catenax.traceability.investigation.domain.model.edc.notification.ContractOfferDescription;
import net.catenax.traceability.investigation.domain.model.edc.notification.NegotiationInitiateRequestDto;
import net.catenax.traceability.investigation.domain.model.edc.notification.TransferId;
import net.catenax.traceability.investigation.domain.model.edc.offer.ContractOffer;
import net.catenax.traceability.investigation.domain.model.edc.policy.Policy;
import net.catenax.traceability.investigation.domain.model.edc.transfer.DataAddress;
import net.catenax.traceability.investigation.domain.model.edc.transfer.TransferRequestDto;
import net.catenax.traceability.investigation.domain.model.edc.transfer.TransferType;
...
public class EdcService {
	...
	public Optional<ContractOffer> findNotificationContractOffer(
		...
		var catalog = httpCallService.getCatalogFromProvider(consumerEdcDataManagementUrl, providerConnectorControlPlaneIDSUrl, header);
	...
	public String initializeContractNegotiation(String providerConnectorUrl, String assetId, String offerId, Policy policy, String consumerEdcUrl,
		...
		var contractOfferDescription = new ContractOfferDescription(offerId, assetId, null, policy);
